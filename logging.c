...
const char *ioregname(int addr)
{
  static char tmpbuf[99];
  switch (addr)
    {
    case SPI_EMU_CMD: return "SPI_EMU_CMD";
    case SPI_USER_CMD: return "SPI_USER_CMD";
    case SPI_BRK_DATA_ADDR: return "SPI_BRK_DATA_ADDR";
    case SPI_BRK_DATA_RW_EN: return "SPI_BRK_DATA_RW_EN";
    case MMU_FREE_LIST_ADDR: return "MMU_FREE_LIST_ADDR";
    case MMU_FLASH_BANK_SELECT: return "MMU_FLASH_BANK_SELECT";
    case MMU_CONST_BANK_SELECT: return "MMU_CONST_BANK_SELECT";
    case MMU_FREE_LIST_NEXT_ADDR: return "MMU_FREE_LIST_NEXT_ADDR";
    case RSTGEN_WATCHDOG_DELAY: return "RSTGEN_WATCHDOG_DELAY";
    case RSTGEN_WATCHDOG_KICK: return "RSTGEN_WATCHDOG_KICK";
    case ANA_VERSION_ID: return "ANA_VERSION_ID";
    case ANA_CONFIG2: return "ANA_CONFIG2";
    case ANA_LO_FREQ: return "ANA_LO_FREQ";
    case ANA_LO_FTRIM: return "ANA_LO_FTRIM";
    case GBL_RST_ENABLES: return "GBL_RST_ENABLES";
    case GBL_TIMER_ENABLES: return "GBL_TIMER_ENABLES";
    case GBL_MISC_ENABLES: return "GBL_MISC_ENABLES";
    case GBL_MISC2_ENABLES: return "GBL_MISC2_ENABLES";
    case GBL_CHIP_VERSION: return "GBL_CHIP_VERSION";
    case GBL_CLK_RATE: return "GBL_CLK_RATE";
    case TIMER_SLOW_TIMER_PERIOD: return "TIMER_SLOW_TIMER_PERIOD";
    case XAP_AH: return "XAP_AH";
    case XAP_AL: return "XAP_AL";
    case XAP_UXH: return "XAP_UXH";
    case XAP_UXL: return "XAP_UXL";
    case XAP_UY: return "XAP_UY";
    case XAP_IXH: return "XAP_IXH";
    case XAP_IXL: return "XAP_IXL";
    case XAP_IY: return "XAP_IY";
    case XAP_FLAGS: return "XAP_FLAGS";
    case XAP_PCH: return "XAP_PCH";
    case XAP_PCL: return "XAP_PCL";
    case XAP_BRK_REGH: return "XAP_BRK_REGH";
    case XAP_BRK_REGL: return "XAP_BRK_REGL";
    case XAP_RSVD_13: return "XAP_RSVD_13";
    case XAP_RSVD_14: return "XAP_RSVD_14";
    case XAP_RSVD_15: return "XAP_RSVD_15";
    default:
      sprintf(tmpbuf, "undocumented (0x%.04x)", addr);
      return tmpbuf;
    }
    }
